  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl rounded-2xl shadow-lg bg-white p-8">
        <h2 className="text-green-600 text-3xl font-semibold text-center mb-2">🎉 Thank You!</h2>
        ...
        <div className="border-t border-gray-200 mt-4 pt-6 grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-10 text-sm text-gray-700">
          ...
          <div>
            ...
            <span className={`ml-2 inline-block px-2 py-1 rounded-full text-xs font-medium ${order.bank_status === "Success" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}>
              {order.bank_status}
            </span>
          </div>
